...
var dotbox = document.querySelector(".dots");
var pre_slide = 0;

function dot_slide_changed() {
    setTimeout(function () {
        for (let dotindex = 0; dotindex <= image_number - 1; dotindex++) {
            dotbox.children[dotindex].classList.remove("stoped")
            dotbox.children[dotindex].classList.remove("next")
            dotbox.children[dotindex].classList.remove("previous")
        }

        if (slide_info == pre_slide) {
            dotbox.children[slide_info].classList.add("stoped")
        }

        else if (pre_slide == image_number - 1 & slide_info == 0) {
            dotbox.children[slide_info].classList.add("stoped")
        }

        else if (pre_slide == 0 & slide_info == image_number - 1) {
            dotbox.children[slide_info].classList.add("stoped")
        }

        else if (slide_info > pre_slide) {
            dotbox.children[slide_info].classList.add("next")
        }

        else if (slide_info < pre_slide) {
            dotbox.children[slide_info].classList.add("previous")
        }
        pre_slide = slide_info;
    }, 1)
    /*
    idx === slide
